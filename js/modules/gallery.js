/* ---------- Galería dinámica: filtros + masonry animado + lightbox ----------
   (galeria.html). Usa MB.revealOnScroll (reveal.js debe cargarse antes). */

(function () {
  window.MB = window.MB || {};

  MB.initGallery = function () {
    ...
    if (typeof MB.revealOnScroll === "function") {
      MB.revealOnScroll(figures, { threshold: 0.15, stagger: 60, staggerMax: 360 });
    } else {
